...
public class CrackSlider {
     ...
     * 轮廓检测，计算缺口位置
     */
    public double getPos(WebElement iframeElement, WebElement element, String imgPath, int num, int num1, int num2) throws IOException {
        ...
        for (MatOfPoint contour : contours) {
            ...
            if (num * num - num * num / 4 < area && area < num * num + num * num / 4 &&
                ...
                return rect.x * num1 / (double) num2 - (iframeElement.getLocation().getX() - element.getLocation().getX());
            }
        }
        return 0;
    }
